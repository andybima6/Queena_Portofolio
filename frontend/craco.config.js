...
let webpackConfig = {
  ...
  webpack: {
    ...
    configure: (webpackConfig) => {
      ...
      // Project ini murni JavaScript (tanpa TypeScript). ForkTsCheckerWebpackPlugin
      // bawaan CRA menyeret ajv/ajv-keywords versi lama yang bentrok di Node 18+/22
      // dan bikin build gagal. Aman untuk dihapus karena tak ada .ts/.tsx.
